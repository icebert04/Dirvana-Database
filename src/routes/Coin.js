    ...
    return (
        <div>
            <div className='coin-container'>
                <div className='content flex ustify-between'>
                    <div>
                    <Link to={'/'}>
                        <span className='transition duration-300 ease-int-out bg-green-800 hover:bg-green-400 hover:text-black text-white font-bold mr-5 py-1 px-2 rounded' >
                        Back
                        </span>
                    </Link>
                    <div className='rank float-right'>
                        <span className='rank-btn py-1 px-2 rounded'>Rank # {coin.market_cap_rank}</span>
                    </div>

                    </div>
                    <div className='info bg-grey-800'>
